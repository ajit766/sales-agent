...
import { FileText, Sparkles, ArrowRight, CheckCircle2, AlertTriangle, UserCheck, CalendarDays, DollarSign, Send, MapPin } from "lucide-react";
import { useMeetingAnalysis } from "../hooks/useMeetingAnalysis";

export function MeetingLoopTab() {
    const {
        transcript,
        setTranscript,
        step,
